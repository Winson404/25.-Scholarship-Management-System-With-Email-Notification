        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              <div class="inner">
                <?php
                  $staff = mysqli_query($conn, "SELECT user_Id from users WHERE user_type='Staff'");
                  $row_staff = mysqli_num_rows($staff);
                ?>
                <h3><?php echo $row_staff; ?></h3>
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
              <div class="inner">
                <?php
                  $users = mysqli_query($conn, "SELECT user_Id from users WHERE user_type='User' AND user_status=1");
                  $row_users = mysqli_num_rows($users);
                ?>
                <h3><?php echo $row_users; ?></h3>

                <p>Qualified grantees</p>
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
