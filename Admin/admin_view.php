<title>Scholarship Management System | Administrator info</title>
<?php 
    include 'navbar.php';
          ...
          <div class="col-md-12">
            <div class="card">      
              ...
              <div class="card-footer float-right">
                ...
                <a class="btn btn-info" href="admin_mgmt.php?page=<?php echo $row['user_Id']; ?>" style="pointer-events: none; opacity: .8;"><i class="fas fa-pencil-alt"></i> Edit</a>
              </div>
